...
public class LaptopsAdapter_TakeItemFilter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App.LaptopsAdapter+TakeItemFilter, App, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", LaptopsAdapter_TakeItemFilter.class, __md_methods);
	}


	public LaptopsAdapter_TakeItemFilter ()
	{
		super ();
		if (getClass () == LaptopsAdapter_TakeItemFilter.class)
			mono.android.TypeManager.Activate ("App.LaptopsAdapter+TakeItemFilter, App, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public LaptopsAdapter_TakeItemFilter (md5f22d74140d7efc8f033f3e312f703c5e.LaptopsAdapter p0)
	{
		super ();
		if (getClass () == LaptopsAdapter_TakeItemFilter.class)
			mono.android.TypeManager.Activate ("App.LaptopsAdapter+TakeItemFilter, App, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "App.LaptopsAdapter, App, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
